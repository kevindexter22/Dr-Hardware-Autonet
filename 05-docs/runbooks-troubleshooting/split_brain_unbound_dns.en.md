...
Unbound intercepts only the server request (e.g. netbox) and gives the private IP. It sends any other request for the root domain to the public DNS servers on the internet.
