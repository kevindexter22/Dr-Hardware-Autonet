<h6 align="right">Leia essa página em <a href="https://github.com/kevindexter22/Dr-Hardware-Autonet/blob/main/03-oss-management/observability/zabbix-stack/zabbix-agent/zabbix_agent_setup.md" target="_blank" rel="noopener noreferrer">🇧🇷 Português</a></h6>

# 🛠️ SOP: Installing Zabbix Agent - Raspberry Pi (ARM64)

### 📝 Description and Scope

This document defines the Standard Operating Procedure (SOP) to install the Zabbix Agent on ARM architecture (Raspberry Pi) with Ubuntu Server 24.04 LTS.

The goal is to allow the server to talk directly to the Zabbix Server (running on an Oracle Cloud VM), sending the metrics and data to be monitored.
...
### 💾 Phase 2: Adjusting communication between Zabbix Agent and Zabbix Server
