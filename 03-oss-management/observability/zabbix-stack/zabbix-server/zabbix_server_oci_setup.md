...
Como estareemos [instalando e configurando o Grafana](#) no mesmo servidor para integrar com o *Zabbix Server*, estaremos [ativando e configurando o proxy do apache](https://github.com/kevindexter22/Dr-Hardware-Autonet/blob/main/03-oss-management/observability/zabbix-stack/zabbix-server/zabbix_server_oci_apache_setup.md) para que ele esteja roteando o tráfego http internamente.
