...
├── casaos/                     # Setup do orquestrador CasaOS
├── os-baseline/                # Padronização e hardening de SO (Day 1)
├── proxmox/                    # Instalação do Hypervisor e Capacity Planning
└── raspberry-pi/               # Provisionamento bare-metal ARM
```
