<h6 align="right">Leia essa página em <a href="https://github.com/kevindexter22/Dr-Hardware-Autonet/blob/main/01-infrastructure/compute-virtualization/os-baseline/baseline_tools_setup.md" target="_blank" rel="noopener noreferrer">🇧🇷 Português</a></h6>
